"""挑一個 patch 丟進訓練好的 v2_ae AE，比較「進去」與「出來」的類別 count。
...
from ae import MLPAE, N_CAT, Patches, poisson_deviance, poisson_nll  # noqa: E402
...
def main():
    ...
    print("latent z = (" + ", ".join(f"{v:+.3f}" for v in z[0].tolist()[:8]) + ("..." if LATENT_DIM > 8 else "") + ")")
