"""訓練 v2_ddae_tanh_fsce：v2_dae_tanh_fsce 的加深變體，模型容量加倍
（encoder/decoder 各 4 層隱藏層），其餘（超參數、denoising、tanh、FSCE
warm-up）全部跟 v2_dae_tanh_fsce 對齊，這樣兩邊的 latent 才是在同一組
