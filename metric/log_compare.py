...
# 若只有路徑，預設會使用檔案名稱作為標籤
log1 = ("model/v2_ddae_residual/result/result.log",'ddae + residual')
log2 = ("model/v2_ddae_residual/result/result-withfsce.log",'ddae + residual + fsce')
log3 = ("model/v2_ddae_fsce/result/result-no-fsce.log",'ddae')
log4 = ("model/v2_ddae_fsce/result/result_base.log",'ddae + fsce')
log5 = ""

# 將所有要比較的 log 變數放入列表中，並自動過濾掉空字串
LOG_FILES = [log for log in [log1, log2, log3, log4, log5] if log]
